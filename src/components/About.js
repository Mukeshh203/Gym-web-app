  ...
  return (
    <Container>
      ...
      <Right>
        ...
        <H2>
          presents your services with flexible, convenient and cdpose
        ...
        <Paragraph>
          Salman Bhai presents your services with flexible, convefnient and chient
          anipurpose layouts. You can select your favorite layouts.
        </Paragraph>

        <Button style={{ marginTop: 30 }}>know your trainer</Button>
      </Right>
    </Container>
  );
}
